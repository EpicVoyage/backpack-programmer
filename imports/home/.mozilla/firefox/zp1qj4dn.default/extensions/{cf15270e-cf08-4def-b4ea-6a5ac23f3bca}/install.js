...
var XpiInstaller = {
  ...
  extLocaleNames : ['be-BY','de-DE','en-US','es-ES','fr-FR','hr-HR','it-IT','nl-NL','pt-BR','zh-CN'],
  ...
  install: function() {
    ...
    // Add temp folder
    //var tempDir = Install.getFolder('Profile','temp');
    //Install.addFile(null, 'temp/blank', tempDir, null);
